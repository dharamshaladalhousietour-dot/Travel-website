  ...
  return (
    <div className="md:hidden bg-white shadow-lg sticky top-0 z-50">
      ...
      <div className="px-4 py-4 flex justify-between items-center">
        {/* Logo */}
        <Link to="/" className="flex items-center pl-4 pr-3">
          <img 
            src="/assets/ppte-logo-new.jpg"
            alt="Pretty Planet Travels and Events - Travel | Corporate Events | Weddings"
            className="h-[35px] w-auto object-contain"
            style={{ maxHeight: '35px', filter: 'contrast(1.08) brightness(1.08) saturate(1.1)' }}
            loading="eager"
          />
        </Link>
        ...
        <div className="border-t border-gray-200 bg-white">
          <div className="px-4 py-6 space-y-6">
            ...
            <div className="space-y-4">
              <Link to="/" className="block text-lg font-medium text-[#0D3B66] hover:text-blue-900 py-2" onClick={() => setIsMenuOpen(false)}>Home</Link>
              <a href="/#about" className="block text-lg font-medium text-[#0D3B66] hover:text-blue-900 py-2" onClick={() => setIsMenuOpen(false)}>About</a>
              <a href="/#services" className="block text-lg font-medium text-[#0D3B66] hover:text-blue-900 py-2" onClick={() => setIsMenuOpen(false)}>Services</a>
