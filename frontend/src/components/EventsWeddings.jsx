  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-white via-[#FDF8F6] to-[#FFF9F7] font-lato">
        ...
        {/* Gold Divider */}
        <div className="w-full h-px bg-gradient-to-r from-transparent via-[#D9B38C] to-transparent my-12"></div>

        {/* Your Wedding Journey Starts Here Section */}
        <section className="py-20 px-4" style={{ backgroundColor: '#FFF9F7' }}>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl font-lato font-light mb-12 max-w-3xl mx-auto animate-fade-in-up" style={{ color: '#3B3B3B', lineHeight: '1.5', animationDelay: '0.2s' }}>
              ...
              Download our exclusive wedding proposal and secure your date with Pretty Planet Travels & Events.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-8 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              <a 
                href="/uploads/WEDDING-CONTRACT-DWH-MAR-2026.pdf" 
                target="_blank" 
              ...
              >
                ...
                Download Full Wedding Proposal (PDF)
              </a>
            ...
            <p className="text-sm font-lato font-light max-w-2xl mx-auto animate-fade-in-up" style={{ color: '#666', lineHeight: '1.6', animationDelay: '0.6s' }}>
              Payments are processed securely through our official gateway.<br />
              Please mention your wedding date or hashtag (e.g., #PSiLoveU) in the notes.
            </p>
          </div>
        </section>
