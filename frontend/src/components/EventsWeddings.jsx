      ...
      <div className="min-h-screen bg-gradient-to-b from-white via-[#FDF8F6] to-[#FFF9F7] font-lato">
        ...
        <div className="fixed bottom-24 right-6 z-50 flex flex-col gap-4">
          ...
          <a
            ...
            className="group relative flex items-center justify-center w-14 h-14 bg-blue-500 hover:bg-blue-600 rounded-full shadow-2xl transform hover:scale-110 transition-all duration-300"
          ...
          {/* WhatsApp Button */}
          <a
            href="https://wa.me/918679333354?text=Hello!%20I'm%20interested%20in%20planning%20a%20destination%20wedding%20in%20Dharamshala."
            target="_blank"
            rel="noopener noreferrer"
            className="group relative flex items-center justify-center w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full shadow-2xl transform hover:scale-110 transition-all duration-300"
          ...
          >
            ...
            <span className="absolute right-16 bg-gray-900 text-white text-sm px-3 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
              Chat with Our Planner on WhatsApp
            </span>
          </a>
        </div>
      </div>
