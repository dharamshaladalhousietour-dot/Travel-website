      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-blue-900 mb-6">
            About <span className="font-playfair"><span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-900 to-purple-600">Pretty Planet</span> <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-orange-500">Travels & Events</span></span>
          </h2>
