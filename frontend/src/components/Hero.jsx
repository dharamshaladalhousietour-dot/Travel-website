    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 py-20 text-center">
        <div className="mb-12">
          ...
          <div className="bg-black/40 backdrop-blur-sm rounded-3xl px-6 py-8 mb-8 max-w-5xl mx-auto">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white mb-0 max-w-3xl mx-auto leading-relaxed text-center px-4">
