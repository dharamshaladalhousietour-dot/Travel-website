          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-4 md:px-8 max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden">
              ...
              <div className="p-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <Button variant="outline" size="sm" className="text-xs border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-semibold" onClick={() => setExpandedPackage(expandedPackage === 2 ? null : 2)}>{expandedPackage === 2 ? 'Hide' : 'View Itinerary'}</Button>
                  <Button size="sm" className="text-xs bg-green-600 hover:bg-green-700 text-white font-semibold" onClick={() => window.location.href = 'tel:+918679333355'}>Call Now</Button>
                  <Button size="sm" className="text-xs bg-blue-600 hover:bg-blue-700 text-white font-semibold" onClick={() => {
                      setSelectedPackage({ title: 'Mystic Hills Retreat', duration: '4D/3N', price: '₹12,999' });
                      setShowEnquiryForm(true);
              ...
              <div className="p-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <Button 
                    ...
                    className="text-xs bg-blue-600 hover:bg-blue-700 text-white"
                    onClick={() => {
                      const message = `Hi! I want to book Queen of Hills – Shimla\n\nDuration: 3D/4N\nPrice: ₹11,999\n\nPlease provide me with more details.`;
              ...
              <div className="p-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <Button 
                    ...
                    className="text-xs bg-blue-600 hover:bg-blue-700 text-white"
                    onClick={() => {
                      const message = `Hi! I want to book Hill Station Trio\n\nDuration: 5D/6N\nPrice: ₹19,999\n\nPlease provide me with more details.`;
                      window.open(`https://wa.me/918679333354?text=${encodeURIComponent(message)}`, '_blank');
                    }}
                  >
                    Submit Booking
              ...
              <div className="p-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <Button 
                    ...
                    className="text-xs bg-blue-600 hover:bg-blue-700 text-white"
                    onClick={() => {
                      const message = `Hi! I want to book Snowbound Paradise\n\nDuration: 4D/5N\nPrice: ₹16,999\n\nPlease provide me with more details.`;
                      window.open(`https://wa.me/918679333354?text=${encodeURIComponent(message)}`, '_blank');
                    }}
                  >
                    Submit Booking
              ...
              <div className="p-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <Button 
                    ...
                    className="text-xs bg-blue-600 hover:bg-blue-700 text-white"
                    onClick={() => {
                      const message = `Hi! I want to book Sacred Bliss Trail\n\nDuration: 3D/4N\nPrice: ₹13,999\n\nPlease provide me with more details.`;
                      window.open(`https://wa.me/918679333354?text=${encodeURIComponent(message)}`, '_blank');
                    }}
                  >
                    Submit Booking
              ...
              <div className="p-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <Button 
                    ...
                    className="text-xs bg-blue-600 hover:bg-blue-700 text-white"
                    onClick={() => {
                      const message = `Hi! I want to book Sky Above Earth Below\n\nDuration: 2D/3N\nPrice: ₹8,999\n\nPlease provide me with more details.`;
                      window.open(`https://wa.me/918679333354?text=${encodeURIComponent(message)}`, '_blank');
                    }}
                  >
                    Submit Booking
              ...
              <div className="p-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <Button 
                    ...
                    className="text-xs bg-blue-600 hover:bg-blue-700 text-white"
                    onClick={() => {
                      const message = `Hi! I want to book The Himalayan Frontier\n\nDuration: 7D/8N\nPrice: ₹29,999\n\nPlease provide me with more details.`;
                      window.open(`https://wa.me/918679333354?text=${encodeURIComponent(message)}`, '_blank');
                    }}
                  >
                    Submit Booking
