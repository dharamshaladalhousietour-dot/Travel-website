  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col">
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-[380px] md:w-[420px] h-[600px] flex flex-col overflow-hidden border-2 border-blue-900 animate-slideUp">
        ...
        {/* Share Details Button - Only after conversation starts */}
        {messages.length > 2 && !showLeadForm && !leadCaptured && (
          <div className="p-3 bg-gray-50 border-t border-gray-200">
            <button
              onClick={() => setShowLeadForm(true)}
              className="w-full px-4 py-2.5 bg-gradient-to-r from-blue-900 to-blue-800 hover:from-blue-800 hover:to-blue-700 text-white text-sm font-bold rounded-lg transition-all shadow-md"
            >
              📋 Share Your Details
            </button>
          </div>
